...
urlpatterns = patterns("agenda.views",
                       ...
                       url("^tag/(?P<tag>.*)/calendar.ics$", "icalendar",
                           name="icalendar_tag"),
                       url(
                           "^location/(?P<location>.*)/feeds/(?P<format>.*)%s$" % _slash,
                       ...
                       url(
                           "^author/(?P<username>.*)/feeds/(?P<format>.*)%s$" % _slash,
                       ...
                       url(
                           "^archive/(?P<year>\d{4})/(?P<month>\d{1,2})%s$" % _slash,
                           "event_list", name="event_list_month"),
                       url(
                           "^archive/(?P<year>\d{4})/(?P<month>\d{1,2})/calendar.ics$",
